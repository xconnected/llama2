...
logging.info('Init LLM')
init_llm(cfg.llm_model, cfg.llm_context_size, cfg.llm_prompts)
...
def chat():
    ...
    logging.info(f'user:{user_message} context:{cfg.llm_context}')

    return jsonify({'elapsed': f' [{t_elapsed:.2f}s] ',
